...
import { ArrowDownWideNarrow, ArrowRight, Bookmark, BriefcaseBusiness, Check, ChevronRight, CircleHelp, Compass, FileCheck2, Gift, GraduationCap, LayoutGrid, LoaderCircle, Plus, Search, ShieldCheck, SlidersHorizontal, Sparkles, Target, TrendingUp, X } from "lucide-react";
...
type View = "catalog" | "mine" | "saved" | "proposals" | "rewards";
...
export default function Home() {
  ...
  const viewTitle = view === "rewards" ? "Комната и награды" : view === "proposals" ? (role === "business" ? "Отклики команд" : "Мои отклики") : view === "mine" ? "Мои задачи" : view === "saved" ? "Мои квесты" : "Каталог задач";
  ...
  return <SidebarProvider style={{ "--sidebar-width": "242px", "--sidebar-width-mobile": "260px" } as React.CSSProperties}>
    <Sidebar className="alem-sidebar">
      ...
      <SidebarContent className="sidebar-body"><p className="nav-caption">РАБОЧЕЕ ПРОСТРАНСТВО</p><SidebarMenu>
        ...
        {role === "student" && <SidebarMenuItem><WorkspaceNavButton isActive={view === "rewards" && !editor} onClick={() => navigate("rewards")}><Gift/><span>Комната и награды</span></WorkspaceNavButton></SidebarMenuItem>}
